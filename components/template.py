...
def _get_data_timestamp() -> str:
    ...
    try:
        ...
        # Format: "# Generated by data_engine.py at 2026-03-27 04:38 UTC"
        if "at " in first_line:
            return first_line.split("at ", 1)[1]
    except Exception:
        pass
    return "recently"
...
def render_page(service: str, country: str) -> None:
    ...
    st.markdown(
        ...
        f"Live pricing · {plan} plan · Converted at real-time exchange rates · "
        f"Last updated: {_get_data_timestamp()}</p>",
        unsafe_allow_html=True,
    )
...
""", unsafe_allow_html=True)
  ...
  <div class="il-card">
    ...
    st.markdown(
        ...
        f'Data last updated: {_get_data_timestamp()} · '
        f'Terms of service compliance is your responsibility. &nbsp;·&nbsp; '
        f'This site contains affiliate links. We may earn a commission at no extra cost to you. &nbsp;·&nbsp; '
